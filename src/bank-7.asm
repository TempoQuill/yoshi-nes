...
@07_e31f:
	...
	LDA iChannelID
IFNDEF POKEMON_RED_MUSIC_SOUNDFONT
	CMP #MUSIC_GAME_POINT
ELSE
	CMP #MUSIC_EVOLUTION_DITTY
ENDIF
	BEQ @07_e31f
IFNDEF POKEMON_RED_MUSIC_SOUNDFONT
	LDA #MUSIC_VS_RESULTS
ELSE
	LDA #MUSIC_TRAINER_VICTORY
ENDIF
	JSR StoreMusicID
	JSR Sub_00_acd9
	JSR Sub_00_8148
